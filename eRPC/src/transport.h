...
enum class TransportType { kInfiniBand, kRaw, kDPDK, kCXL, kUB, kFake, kInvalid };
...
class Transport {
 public:
  ...
  struct tx_burst_item_t {
    ...
    bool drop_ = false;        ///< Drop this packet. Used only with kTesting.
  };
  ...
  static std::string get_name(TransportType transport_type) {
    switch (transport_type) {
      ...
      case TransportType::kCXL: return "[CXL Shared Memory]";  // 新增
      case TransportType::kUB: return "[UB Shared Memory]";
