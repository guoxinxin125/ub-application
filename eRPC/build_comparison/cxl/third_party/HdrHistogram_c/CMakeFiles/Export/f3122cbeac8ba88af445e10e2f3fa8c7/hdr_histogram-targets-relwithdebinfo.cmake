...
set_target_properties(hdr_histogram::hdr_histogram PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib64/libhdr_histogram.so.6.1.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdr_histogram.so.6"
  )

list(APPEND _cmake_import_check_targets hdr_histogram::hdr_histogram )
list(APPEND _cmake_import_check_files_for_hdr_histogram::hdr_histogram "${_IMPORT_PREFIX}/lib64/libhdr_histogram.so.6.1.1" )
...
set_target_properties(hdr_histogram::hdr_histogram_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib64/libhdr_histogram_static.a"
  )

list(APPEND _cmake_import_check_targets hdr_histogram::hdr_histogram_static )
list(APPEND _cmake_import_check_files_for_hdr_histogram::hdr_histogram_static "${_IMPORT_PREFIX}/lib64/libhdr_histogram_static.a" )
